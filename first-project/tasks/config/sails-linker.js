	...
	grunt.config.set('sails-linker', {
		devJs: {
			...
			files: {
				...
				'views/**/*.handlebars': ['.tmp/public/browserify/debug.' + version + '.js']
			}
		},
		...
		prodJs: {
			...
			files: {
				...
				'views/**/*.handlebars': ['.tmp/public/min/production.' + version + '.min.js']
			}
		},
		...
		prodStyles: {
			...
			files: {
				...
				'views/**/*.handlebars': ['.tmp/public/min/production.' + version + '.min.css']
			}
		},
